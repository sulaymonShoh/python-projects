"""
NEW METHOD - 23 lines - this is able to translate numbers that smaller than 100,000,000,000
"""
def translate(number):
	...
	if number.isdigit():
		...
		if len(list_number) > 11: print('Dastur hozircha 11 xonali sonlar uchun mo\'ljallangan')
...
print(translate(input('Son kiriting: ')))